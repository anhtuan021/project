...
const translations = {
  ...
  vi: {
    ...
    'home.featured.subtitle': 'Khám phá các nhiếp ảnh gia tài năng từ khắp nơi trên thế giới, mỗi người mang đến phong cách và chuyên môn độc đáo để ghi lại những khoảnh khắc đặc biệt của b���n.',
    ...
    'support.matchingProcessDesc': 'Cách thức ho��t động của AI ghép đôi',
    ...
    'support.aiGreeting': 'Xin chào! Tôi là trợ lý AI SnapMatch của bạn. Tôi có thể giúp gì cho b���n hôm nay?',
    ...
    'admin.january2024': 'Th��ng 1/2024',
    ...
    'bookingModal.totalCost': 'Tổng Chi Phí:',
    ...
    'notifications.systemUpdateDesc': 'Tính năng AI mới ��ã được thêm vào nền tảng',
