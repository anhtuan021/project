...
const translations = {
  ...
  vi: {
    ...
    'home.cta.subtitle': 'Tham gia cùng hàng nghìn kh��ch hàng và nhiếp ��nh gia hài lòng tin tưởng SnapMatch AI',
    ...
    'signup.leftFeature': 'Tạo ra nh���ng thiết kế tuyệt vời với SnapMatch AI',
    ...
    'aiTools.aiEnhanced': 'Xem Trư��c Được Nâng Cấp Bởi AI',
    ...
    'home.features.styleTransferDesc': 'Biến đổi ảnh của bạn với bộ lọc nghệ thuật được hỗ trợ b��i AI',
    ...
    'profile.suggestionTitles.romanticWedding': '��nh cưới lãng mạn',
