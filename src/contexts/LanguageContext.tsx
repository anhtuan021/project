...
const translations = {
  ...
  vi: {
    ...
    'home.featured.subtitle': 'Khám phá các nhiếp ảnh gia tài năng từ khắp nơi tr��n thế giới, mỗi người mang đến phong cách và chuyên môn độc đáo để ghi lại những khoảnh khắc đặc biệt của bạn.',
    ...
    'listing.mapDescription': 'Bản đồ tương tác với v��� trí nhiếp ảnh gia',
