...
const translations = {
  ...
  vi: {
    ...
    'home.aiPowered.subtitle': 'Trải nghiệm tương lai c���a nhiếp ảnh với các công cụ AI tiên tiến giúp nâng cao mọi khía cạnh trong hành trình chụp ảnh của bạn.',
    ...
    'listing.allSpecialties': 'Tất Cả Chuyên M��n',
    ...
    'support.contactSupport': 'Liên Hệ Hỗ Trợ',
        'support.quickActions.booking': 'Làm thế nào để ��ặt lịch?',
    ...
    'notifications.timeAgo.hour': 'gi�� trước',
    ...
    'home.testimonials.realReview1': 'Nhiếp ảnh gia đã ghi lại ngày cưới của chúng tôi một cách hoàn hảo. Những bức ảnh đư��c nâng cấp bởi AI thật tuyệt vời!',
    'home.testimonials.realClient2': 'Mark Thompson',
