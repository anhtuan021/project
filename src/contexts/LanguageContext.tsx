...
const translations = {
  ...
  vi: {
    ...
    'signup.leftSide.title': 'Tham gia thế giới sáng tạo của SnapMatch AI',
    'signup.leftSide.subtitle': 'Biến ý tưởng của bạn thành hiện thực với sự sáng tạo được hỗ trợ bởi AI',
    'signup.leftSide.feature': 'Tạo ra những thiết kế tuyệt vời với SnapMatch AI',
    ...
    // Photographer Listing Page
    'photographers.title': 'Tìm Nhiếp Ảnh Gia',
    'photographers.subtitle': 'Khám phá các nhiếp ảnh gia tài năng trong khu vực của bạn',
    'photographers.grid': 'Lưới',
    'photographers.map': 'Bản Đồ',
    'photographers.filters': 'Bộ Lọc',
    'photographers.search': 'Tìm Kiếm',
    'photographers.searchPlaceholder': 'Tên, địa điểm hoặc chuyên môn...',
    'photographers.specialty': 'Chuyên Môn',
    'photographers.allSpecialties': 'Tất Cả Chuyên Môn',
    'photographers.priceRange': 'Khoảng Giá',
    'photographers.anyPrice': 'Bất Kỳ Giá Nào',
    'photographers.location': 'Địa Điểm',
    'photographers.locationPlaceholder': 'Thành phố hoặc khu vực...',
    'photographers.availability': 'Tình Trạng',
    'photographers.anyTime': 'Bất Kỳ Lúc Nào',
    'photographers.availableNow': 'Có Sẵn Ngay',
    'photographers.availableTomorrow': 'Có Sẵn Ngày Mai',
    'photographers.availableNextWeek': 'Có Sẵn Tuần Sau',
    'photographers.clearFilters': 'Xóa Tất Cả Bộ Lọc',
    'photographers.found': 'nhiếp ảnh gia',
    'photographers.foundPlural': 'nhiếp ảnh gia',
    'photographers.foundText': 'được tìm thấy',
    'photographers.filteredFromSearch': '(được lọc từ tìm kiếm)',
    'photographers.sortBy': 'Sắp xếp theo: Liên quan',
    'photographers.sortRelevance': 'Sắp xếp theo: Liên quan',
    'photographers.sortRating': 'Sắp xếp theo: Đánh giá',
    'photographers.sortPriceLow': 'Sắp xếp theo: Giá (Thấp đến Cao)',
    'photographers.sortPriceHigh': 'Sắp xếp theo: Giá (Cao đến Thấp)',
    'photographers.sortAvailability': 'Sắp xếp theo: Tình trạng',
    'photographers.verified': 'Đã Xác Minh',
    'photographers.viewProfile': 'Xem Hồ Sơ',
    'photographers.bookNow': 'Đặt Ngay',
    'photographers.mapComingSoon': 'Chế độ xem bản đồ sắp ra mắt',
    'photographers.mapDescription': 'Bản đồ tương tác với vị trí nhiếp ảnh gia',
    'photographers.noResults': 'Không tìm thấy nhiếp ảnh gia',
    'photographers.noResultsDesc': 'Thử điều chỉnh tiêu chí tìm kiếm hoặc bộ lọc',
    ...
    'aiTools.autoEditor': 'Công Cụ Chỉnh Sửa Tự Động',
    'aiTools.autoEditorDesc': 'Chỉnh sửa và nâng cấp ảnh được hỗ trợ bởi AI',
