...
const translations = {
  en: {
    ...
    'admin.monthlyRevenue': 'Revenue/Month',
  ...
  vi: {
    ...
    'home.testimonials.subtitle': 'Đ���ng chỉ tin lời chúng tôi. Đây là những gì khách hàng hài lòng nói về trải nghiệm của họ.',
    ...
    'aiTools.enhancedPreview': 'Ảnh đư���c nâng cấp sẽ xuất hiện ở đây',
    ...
    'admin.totalUsers': 'Tổng Ngư���i Dùng',
    ...
    'aiTools.dragDropPhoto': 'Kéo và thả ảnh của bạn vào đây',
