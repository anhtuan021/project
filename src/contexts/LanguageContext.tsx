...
const translations = {
  en: {
    ...
    'editProfile.errorFullNameRequired': 'Full name is required',
    'editProfile.errorEmailRequired': 'Email is required',
    'editProfile.errorEmailInvalid': 'Invalid email format',
    'editProfile.errorPhoneInvalid': 'Invalid phone number',
    'editProfile.errorWebsiteInvalid': 'Website must start with http:// or https://',
    'editProfile.errorGeneral': 'An error occurred. Please try again!',
    'editProfile.errorPasswordMismatch': 'New passwords do not match!',
    'editProfile.errorPasswordLength': 'New password must be at least 6 characters!',
    'editProfile.passwordChangeSuccess': 'Password changed successfully!',
    'editProfile.deleteAccountConfirm': 'Are you sure you want to delete your account? This action cannot be undone.',
    'editProfile.deleteAccountFinalConfirm': 'Final confirmation: All your data will be permanently deleted!',
    'editProfile.deleteAccountSuccess': 'Account has been deleted successfully!',
    'editProfile.statusLabel': 'Status',
    'editProfile.statusVerified': 'Verified',
    'editProfile.personalInfo': 'Personal Information',
    'editProfile.address': 'Address',
    'editProfile.bio': 'Bio',
    'editProfile.bioPlaceholder': 'Write a few lines about yourself...',
    'editProfile.website': 'Website',
    'editProfile.security': 'Security',
    'editProfile.passwordDesc': 'Change your login password',
    'editProfile.preferences': 'Preferences',
    'editProfile.saving': 'Saving...',
    'editProfile.dangerZone': 'Danger Zone',
    'editProfile.dangerZoneDesc': 'Deleting your account will permanently delete all your data',
    ...
    'aiTools.aiToolsTitle': 'AI Tools',
    'aiTools.categoryNature': 'Nature',
    'aiTools.categoryPortrait': 'Portrait',
    'aiTools.categoryUrban': 'Urban',
    'aiTools.categoryAbstract': 'Abstract',
    'aiTools.conceptGoldenHour': 'Golden Hour Portrait',
    'aiTools.conceptGoldenHourDesc': 'Warm, natural lighting with soft shadows',
    'aiTools.conceptUrban': 'Urban Portrait',
    'aiTools.conceptUrbanDesc': 'City backdrop with dramatic lighting',
    'aiTools.conceptStudio': 'Studio Setup',
    'aiTools.conceptStudioDesc': 'Professional studio with controlled lighting',
    'aiTools.conceptNatural': 'Natural Environment',
    'aiTools.conceptNaturalDesc': 'Outdoor setting with natural elements',
    'aiTools.photographer1': 'Photographer 1',
    'aiTools.photographer2': 'Photographer 2',
    'aiTools.photographer3': 'Photographer 3',
    'aiTools.specialtyWedding': 'Wedding',
    'aiTools.tagPortrait': 'Portrait',
    'aiTools.match98': '98% Match',
    'aiTools.match96': '96% Match',
    'aiTools.match94': '94% Match',
    'aiTools.orBrowseFiles': 'or browse files',
    'aiTools.tagWedding': '#Wedding',
    'aiTools.tagFashion': '#Fashion',
    'aiTools.tagStreet': '#Street',
    'aiTools.tagNature': '#Nature',
    ...
    'home.search.styles.other': 'Other',
  ...
  vi: {
    ...
    'signup.leftFeature': 'Tạo ra những thiết kế tuyệt v���i với SnapMatch AI',
    ...
    'editProfile.errorFullNameRequired': 'Họ tên không được để trống',
    'editProfile.errorEmailRequired': 'Email không được để trống',
    'editProfile.errorEmailInvalid': 'Email không hợp lệ',
    'editProfile.errorPhoneInvalid': 'Số điện thoại không hợp lệ',
    'editProfile.errorWebsiteInvalid': 'Website phải bắt đầu với http:// hoặc https://',
    'editProfile.errorGeneral': 'Có lỗi xảy ra. Vui lòng thử lại!',
    'editProfile.errorPasswordMismatch': 'Mật khẩu mới không khớp!',
    'editProfile.errorPasswordLength': 'Mật khẩu mới phải có ít nhất 6 ký tự!',
    'editProfile.passwordChangeSuccess': 'Đã thay đổi mật khẩu thành công!',
    'editProfile.deleteAccountConfirm': 'Bạn có chắc chắn muốn xóa tài khoản? Hành động này không thể hoàn tác.',
    'editProfile.deleteAccountFinalConfirm': 'Lần xác nhận cuối cùng: Tất cả dữ liệu của bạn sẽ bị xóa vĩnh viễn!',
    'editProfile.deleteAccountSuccess': 'Tài khoản đã được xóa thành công!',
    'editProfile.statusLabel': 'Trạng thái',
    'editProfile.statusVerified': 'Đã xác thực',
    'editProfile.personalInfo': 'Thông tin cá nhân',
    'editProfile.address': 'Địa chỉ',
    'editProfile.bio': 'Giới thiệu bản thân',
    'editProfile.bioPlaceholder': 'Viết vài dòng về bản thân...',
    'editProfile.website': 'Website',
    'editProfile.security': 'Bảo mật',
    'editProfile.passwordDesc': 'Thay đổi mật khẩu đăng nhập',
    'editProfile.preferences': 'Tùy chọn',
    'editProfile.saving': 'Đang lưu...',
    'editProfile.dangerZone': 'Vùng nguy hiểm',
    'editProfile.dangerZoneDesc': 'Xóa tài khoản sẽ xóa vĩnh viễn tất cả dữ liệu của bạn',
    'editProfile.deleteAccount': 'Xóa tài khoản',
    'editProfile.currentPassword': 'Mật khẩu hiện tại',
    'editProfile.newPassword': 'Mật khẩu mới',
    'editProfile.confirmPassword': 'Xác nhận mật khẩu mới',
    'editProfile.change': 'Thay đổi',
    ...
    'photographerProfile.projectsCompleted': 'D�� Án Hoàn Thành',
    ...
    'aiTools.detectedTags': 'Th��� Phong Cách Được Phát Hiện',
    ...
    'aiTools.aiToolsTitle': 'Công Cụ AI',
    'aiTools.categoryNature': 'Thiên Nhiên',
    'aiTools.categoryPortrait': 'Chân Dung',
    'aiTools.categoryUrban': 'Đô Thị',
    'aiTools.categoryAbstract': 'Trừu Tượng',
    'aiTools.conceptGoldenHour': 'Chân Dung Golden Hour',
    'aiTools.conceptGoldenHourDesc': 'Ánh sáng tự nhiên ấm áp với bóng mềm',
    'aiTools.conceptUrban': 'Chân Dung Đô Thị',
    'aiTools.conceptUrbanDesc': 'Bối cảnh thành phố với ánh sáng ấn tượng',
    'aiTools.conceptStudio': 'Thiết Lập Studio',
    'aiTools.conceptStudioDesc': 'Studio chuyên nghiệp với ánh sáng được kiểm soát',
    'aiTools.conceptNatural': 'Môi Trường Tự Nhiên',
    'aiTools.conceptNaturalDesc': 'Bối cảnh ngoài trời với các yếu tố tự nhiên',
    'aiTools.photographer1': 'Nhiếp Ảnh Gia 1',
    'aiTools.photographer2': 'Nhiếp Ảnh Gia 2',
    'aiTools.photographer3': 'Nhiếp Ảnh Gia 3',
    'aiTools.specialtyWedding': 'Cưới',
    'aiTools.tagPortrait': 'Chân Dung',
    'aiTools.match98': '98% Khớp',
    'aiTools.match96': '96% Khớp',
    'aiTools.match94': '94% Khớp',
    'aiTools.orBrowseFiles': 'hoặc duyệt tệp',
    'aiTools.tagWedding': '#Cưới',
    'aiTools.tagFashion': '#Thời_Trang',
    'aiTools.tagStreet': '#Đường_Phố',
    'aiTools.tagNature': '#Thiên_Nhiên',
    ...
    'feedback.placeholder': 'Chia sẻ trải nghiệm của bạn về dịch v��� chụp ảnh...',
    'feedback.cancel': 'Hủy',
    ...
    'notifications.newMessageDesc': 'Tr���n Thị B đã gửi tin nhắn về buổi chụp ảnh gia đình',
    ...
    'notifications.timeAgo.minutes': 'phút trư��c',
    ...
    'home.search.styles.event': 'S�� Kiện',
    'home.search.styles.other': 'Khác',
    'home.search.budget.range1': '$0 - $50',
    'home.search.budget.range2': '$50 - $100',
    'home.search.budget.range3': '$100 - $200',
    'home.search.budget.range4': '$200+',
    ...
    'header.dashboard': 'Dashboard',
    'header.adminDashboard': 'Admin Dashboard',
    'header.photographerSettings': 'Cài đặt Profile',
    'header.adminProfile': 'Admin Profile',

    // Personal Profile Page
    'profile.customer': 'Khách hàng',
    'profile.defaultConceptRequirements': 'Chụp ảnh tự nhiên, phong cách hiện đại với ánh sáng tự nhiên. Tập trung vào cảm xúc và khoảnh khắc chân thực.',
    'profile.defaultSpecialNotes': 'Vui lòng đến đúng giờ. Mang theo trang phục dự phòng.',
    'profile.photographerSaved': 'Đã lưu nhiếp ảnh gia vào danh sách yêu thích!',
    'profile.photographerAlreadySaved': 'Nhiếp ảnh gia này đã có trong danh sách yêu thích!',
    'profile.photographerUnsaved': '��ã xóa khỏi danh sách yêu thích!',
    ...
    'profile.conceptSaved': 'Đã lưu concept vào danh sách yêu thích!',
    'profile.conceptAlreadySaved': 'Concept này đã có trong danh sách yêu thích!',
    'profile.findPhotographerForConcept': 'Tìm nhiếp ảnh gia cho concept "{{title}}" trong danh mục {{category}}',
    'profile.refreshingSuggestions': 'Đang làm mới gợi ý AI dựa trên sở thích và lịch sử của bạn...',
    'profile.suggestionsUpdated': 'Đã cập nhật gợi ý mới!',
    'profile.memberSince': 'Thành viên từ {{date}}',
    'profile.loyaltyPoints': '{{points}} điểm tích lũy',
    'profile.totalSpent': 'Tổng chi tiêu',
    'profile.edit': 'Chỉnh sửa',
    'profile.totalBookings': 'Tổng số booking',
    'profile.completedBookings': '+{{count}} hoàn thành',
    'profile.upcomingBookings': 'Booking sắp tới',
    'profile.getReady': 'Chuẩn bị s��n sàng',
    'profile.averageSpending': 'Chi tiêu trung bình',
    'profile.perSession': 'Mỗi phiên chụp',
    'profile.loyaltyPointsLabel': 'Điểm tích lũy',
    'profile.redeemable': 'Có thể đổi quà',
    'profile.tabs.overview': 'Tổng quan',
    'profile.tabs.bookingHistory': 'Lịch sử Booking',
    'profile.tabs.favorites': 'Yêu thích',
    'profile.tabs.aiSuggestions': 'Gợi ý AI',
    'profile.overview.weeklyBookings': 'Booking tuần này',
    'profile.overview.favoritePhotographers': 'Nhiếp ảnh gia yêu thích',
    'profile.overview.savedConcepts': 'Concept đã lưu',
    'profile.overview.recentActivities': 'Hoạt động gần đây',
    'profile.overview.upcomingBookings': 'Booking sắp tới',
    'profile.overview.noUpcomingBookings': 'Không có booking nào sắp tới',
    'profile.overview.bookNow': 'Đ���t ngay',
    'profile.bookings.title': 'Lịch sử Booking',
    'profile.bookings.confirmed': 'Đã xác nhận: {{count}}',
    'profile.bookings.completed': 'Hoàn thành: {{count}}',
    'profile.bookings.bookNew': 'Đặt mới',
    'profile.bookings.duration': 'Thời lượng: {{duration}} giờ',
    'profile.bookings.reference': 'Mã: {{ref}}',
    'profile.bookings.actions.rate': 'Đánh giá',
    'profile.bookings.actions.cancel': 'Hủy booking',
    'profile.bookings.actions.message': 'Nhắn tin',
    'profile.bookings.actions.viewDetails': 'Xem chi tiết',
    'profile.bookings.noBookings': 'Chưa có booking nào',
    'profile.bookings.noBookingsSubtitle': 'Hãy tìm và đặt nhiếp ảnh gia đầu tiên của bạn',
    'profile.bookings.findPhotographer': 'Tìm nhiếp ảnh gia',
    'profile.favorites.title': 'Nhiếp ảnh gia yêu thích',
    'profile.favorites.viewAll': 'Xem tất cả',
    'profile.favorites.removeFromFavorites': 'Xóa khỏi yêu thích',
    'profile.favorites.rebook': 'Đặt lại',
    'profile.favorites.sendMessage': 'Gửi tin nhắn',
    'profile.suggestions.title': 'Gợi ý AI dành cho bạn',
    'profile.suggestions.refresh': 'Làm mới gợi ý',
    'profile.suggestions.match': '{{percentage}} khớp',
    'profile.suggestions.findPhotographer': 'Tìm nhiếp ảnh gia',
    'profile.suggestions.saveConcept': 'Lưu concept',
    'profile.activities.bookingCompleted': 'Bạn đã hoàn thành phiên chụp với {{photographer}}',
    'profile.activities.daysAgo': '{{days}} ngày trước',
    'profile.activities.photographerSaved': 'Đã lưu {{photographer}} vào danh sách yêu thích',
    'profile.activities.weeksAgo': '{{weeks}} tuần trước',
    'profile.activities.pointsEarned': 'Nhận được {{points}} điểm loyalty từ booking gần nhất',
    'profile.suggestionTitles.romanticWedding': 'Ảnh cưới lãng mạn',
    'profile.suggestionDescriptions.romanticWedding': 'Phong cách cổ điển với ánh sáng golden hour',
    'profile.suggestionTitles.artisticPortrait': 'Chân dung nghệ thuật',
    'profile.suggestionDescriptions.artisticPortrait': 'Phong cách hiện đại với hiệu ứng ánh s��ng',
    'profile.suggestionTitles.outdoorFamily': 'Ảnh gia đình ngoài trời',
    'profile.suggestionDescriptions.outdoorFamily': 'Tự nhiên và ấm áp trong thiên nhiên',
    ...
    'photographerDashboard.vintageWeddingDesc': 'Phong cách cổ điển với tông màu ấm, ánh sáng tự nhiên',
