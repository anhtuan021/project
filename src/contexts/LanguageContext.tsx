...
const translations = {
  ...
  vi: {
    ...
    'home.featured.subtitle': 'Khám phá các nhiếp ảnh gia tài năng từ khắp nơi trên thế giới, mỗi người mang đến phong cách và chuyên môn độc đáo để ghi lại những khoảnh khắc đặc bi��t của bạn.',
    ...
    'home.howItWorks.step3.description': 'Nhận những bức ảnh được chỉnh sửa chuyên nghiệp và nâng cấp b���i AI.',
    ...
    'booking.reviewBooking': 'Xem Lại Đặt Lịch',
        'booking.totalCost': 'T��ng Chi Phí',
    ...
    'dashboard.conceptPortfolio': 'Concept & Portfolio',
    'dashboard.recentBookings': 'Booking Gần Đây',
    ...
    'home.features.styleTransferDesc': 'Biến đổi ảnh của b���n với bộ lọc nghệ thuật được hỗ trợ bởi AI',
    ...
    // AI Tools Page Additional
    'aiTools.conceptGenerator': 'Tạo Ý Tưởng',
    'aiTools.conceptGeneratorDesc': 'Tạo ý tưởng nhiếp ảnh sáng tạo từ văn bản',
    'aiTools.autoEditingTool': 'Công Cụ Chỉnh Sửa Tự Động',
    'aiTools.autoEditingToolDesc': 'Chỉnh sửa và nâng cấp ảnh được hỗ trợ bởi AI',
    'aiTools.styleMatcher': 'Ghép Đôi Phong Cách',
    'aiTools.styleMatcherDesc': 'Tìm nhiếp ảnh gia có thẩm mỹ phù hợp',
    'aiTools.aiTools': 'Công Cụ AI',
    'aiTools.dragDropPhoto': 'Kéo và thả ��nh của bạn vào đây',
    'aiTools.orBrowseFiles': 'hoặc duyệt tệp',
    'aiTools.browseFiles': 'Duyệt Tệp',
    'aiTools.enhancedPreview': 'Ảnh được nâng cấp sẽ xuất hiện ở đây',
    'aiTools.uploadReference': 'Tải ảnh tham khảo lên',
    'aiTools.styleTags.wedding': '#Cưới',
    'aiTools.styleTags.portrait': '#ChânDung',
    'aiTools.styleTags.vintage': '#CổĐiển',
    'aiTools.styleTags.modern': '#HiệnĐại',
    'aiTools.styleTags.romantic': '#LãngMạn',
    'aiTools.styleTags.elegant': '#TrangNhã',

    // Photographer Listing Additional
    'listing.found': 'được tìm thấy',
    'listing.verified': 'Đã Xác Minh',
    'listing.mapComingSoon': 'Chế độ xem bản đồ sắp ra mắt',
    'listing.mapDescription': 'Bản đồ tương tác với vị trí nhiếp ảnh gia',
    'listing.noResults': 'Không tìm thấy nhiếp ảnh gia',
