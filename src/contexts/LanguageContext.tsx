...
const translations = {
  ...
  vi: {
    ...
    'listing.priceLowHigh': 'Gi�� (Thấp đến Cao)',
    ...
    'booking.notesPlaceholder': 'Cho chúng tôi biết thêm v��� sự kiện hoặc yêu cầu cụ thể...',
    ...
    'aiTools.themePlaceholder': 'ví dụ: đ��m cưới hoàng hôn lãng mạn, chân dung đô thị hiện đại...',
    ...
    'support.gettingStartedDesc': 'Tìm hiểu những điều c�� bản về SnapMatch AI',
    ...
    'dashboard.responseRate': 'Tỷ L��� Phản Hồi',
